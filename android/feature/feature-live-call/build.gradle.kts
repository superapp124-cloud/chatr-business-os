...
dependencies {
    ...
    add("implementation", project(":ml:ml-fraud"))
    add("implementation", project(":ml:ml-transcription"))
    add("implementation", project(":telecom:telecom-engine"))
